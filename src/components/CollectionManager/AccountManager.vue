...
<template>
    <div class="pt-16" v-if="auth && user && isDashboard">
        ...
        <!-- Breadcrumb -->
        <nav class="px-4 py-2 transition sm:px-6 lg:z-30 lg:px-4 backdrop-blur-sm dark:backdrop-blur text-gray-700 border border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
            <div class="sm:flex items-center justify-between px-2">
