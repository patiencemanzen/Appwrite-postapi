...
<template>
  <footer class="mx-auto space-y-10 pb-16 h-20">
    <div class="flex flex-col items-center justify-between gap-5 px-16 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      <p class="text-xs text-zinc-600 dark:text-zinc-400"> © Copyright 2023, Patienceman. All rights reserved.</p>
