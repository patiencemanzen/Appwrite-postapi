...
<template>
  <div class="relative py-16 bg-gradient-to-br h-[90vh]">
    <div class="relative container m-auto px-6 text-gray-500 md:px-12 xl:px-40">
        <div class="m-auto md:w-8/12 lg:w-6/12 xl:w-6/12 pt-32">
            <div><PatternsVue /></div>

            <div class="rounded-xl ring-1 ring-zinc-900/10 transition hover:ring-zinc-900/20 dark:ring-white/10 dark:hover:ring-white/20 dark:bg-white/5">
                <div class="p-16 sm:p-16">
                    ...
                    <div class="socialite not-prose flex justify-center items-center">
                      <a @click="loginWithGitHub" class="inline-flex gap-0.5 justify-center cursor-pointer overflow-hidden text-sm font-medium transition rounded-full bg-zinc-900 py-3 px-10 text-white hover:bg-zinc-700 dark:bg-emerald-400/10 dark:text-emerald-400 dark:ring-1 dark:ring-inset dark:ring-emerald-400/20 dark:hover:bg-emerald-400/10 dark:hover:text-emerald-300 dark:hover:ring-emerald-300">
                      ...
                      <a @click="loginWithGoogle" class="inline-flex gap-0.5 justify-center ml-5 cursor-pointer overflow-hidden text-sm font-medium transition rounded-full py-3 px-10 text-zinc-700 ring-1 ring-inset ring-zinc-900/10 hover:bg-zinc-900/2.5 hover:text-zinc-900 dark:text-zinc-400 dark:ring-white/10 dark:hover:bg-white/5 dark:hover:text-white">
...
onMounted(async () => {
  if (await Auth().check()) window.location.replace("/dashboard");
});
</script>
