        ...
        <div class="m-auto md:w-8/12 lg:w-6/12 xl:w-6/12">
            <div class="rounded-xl border border-gray-200 dark:bg-gray-700">
                ...
                <div class="p-6 sm:p-16">
                    ...
                    <div class="socialites mt-16 grid space-y-1">
                        <button @click="loginWithGoogle" class="text-white font-anek bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-[10px] text-md px-3 py-3 text-center inline-flex items-center justify-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
                            ...
                            <span class="mt-1" style="font-size: 19px;margin-left: 5px">Google Account</span>
                        </button>
                        <button @click="loginWithGitHub" class="text-white font-anek bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-[10px] text-md px-3 py-3 text-center inline-flex items-center justify-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
                            ...
                            <span class="mt-1" style="font-size: 19px; margin-left: 5px">Gihub Account</span>
                        </button>
                    </div>
                </div>
