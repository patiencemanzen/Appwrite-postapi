...
<template>
  <div class="">
    <div class="relative px-4 sm:px-6 lg:px-8 flex">
      <main class="py-16 px-10 w-[900px]">
        <article class="prose dark:prose-invert">
          <div><PatternsVue /></div>

          <h1 class="text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl">Organize Your Postman API Collections &amp; Document</h1>
          <p class="lead">
          ...
          <h2 class="scroll-mt-20">Getting started</h2>
          <p class="lead">
